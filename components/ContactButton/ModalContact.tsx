            ...
            <>
              ...
              <ModalBody className=" relative z-10 mt-8">
                ...
                <div className="mt-6">
                  ...
                  <div className=" mt-4 md:inline-block align-middle bg-primary/60 text-center backdrop-blur-2xl text-primary/60 rounded-3xl px-5 py-2">
                   <p className="inline-block me-2"><svg
                       className="-mb-1"
                       width="20"
                       height="20"
                       viewBox="0 0 24 24"
                    ...
                    {siteConfig?.footer?.contact.phone.map((data, index) => (
                      <Link
                        className="me-3 text-white transition-all hover:text-primary-800 align-middle"
                        key={index}
